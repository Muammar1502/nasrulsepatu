...
$routes->post('/update-status-order', 'Pages::updateStatusOrder', ['filter' => 'userFilter']);
$routes->post('/update-status-order-user', 'Pages::updateStatusOrderDua', ['filter' => 'userFilter']);
...
$routes->group('dashboard', ['filter' => 'adminFilter'], function($routes){
    ...
    $routes->post('/filter', 'Dashboard::filter');
    ...
    $routes->get('data-transaksi/sudah-sampai', 'Dashboard\Transaksi::sudah_sampai');
